...
class _MyAppState extends State<MyApp> {
  ...
  Future<void> updateUI(LocationDto data) async {
    ...
    final _dbHelper = DatabaseHandler.instance;
    final dbLogStr = await _dbHelper.getAllNotes();

    String x = '';

    if (dbLogStr != null) {
      (dbLogStr).forEach((element) {
        x +=
            '${element[DatabaseHandler.columnId]}. (${element[DatabaseHandler.columnLat]}, ${element[DatabaseHandler.columnLong]})';
        int epoch =
            int.parse(element[DatabaseHandler.columnTimestamp].toString());
